...
typedef enum {
    ...
    FH_SAVE, FH_LOAD, FH_PLOT, FH_IPLOT, FH_MANDELBROT, FH_MANDEL_ITER, FH_TSCATTER, FH_PLANET, FH_SOLVE, FH_CONST_CMD,
    ...
    FH_TOPREVENUE, FH_CONCENTRATION, FH_REVCHURN,
    FH_NETCHURN, FH_QUICKRATIO, FH_LTV,
